...
public class GithubRepositoryTest {
    ...
    public void setUp() throws Exception {
        initMocks(this);
        setField(restClient, "restTemplate", restTemplate);
        setField(restClient, "githubUsersUrl", "https://api.github.com/users/%s");
        setField(restClient, "githubFollowersUrl", "https://api.github.com/users/%s/followers");
        setField(restClient, "githubReposUrl", "https://api.github.com/users/%s/repos");
